...
class Arbitration_1 extends Module{
    val io = IO (new Bundle{
        ...
        when(FIFO_A_1_2_node.io.empty === 0.U){
        ...
        }.elsewhen(FIFO_2_empty === 1.U&&FIFO_1_empty === 0.U){
            io.node_id_out                   := FIFO_A_1_1_node.io.dataout
            io.ray_id_out                       := FIFO_A_1_1_ray.io.dataout
            io.hit_out                              := 0.U
            io.valid_out                         := valid_out_temp
            // valid_out_temp                         := 1.U
        }.elsewhen(FIFO_2_empty === 1.U&&FIFO_1_empty === 1.U&&FIFO_0_empty === 0.U){
