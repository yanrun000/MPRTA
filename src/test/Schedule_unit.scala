...
import org.scalatest._
 class Schedule_unit extends Module{
    ...
    val FIFO_v11                = Module(new FIFO_0(128,10))
    val FIFO_v22                = Module(new FIFO_0(128,10))
    val FIFO_ray                 = Module(new FIFO_0(32,10))
    val FIFO_Oz                  = Module(new FIFO_0(32,10))
    val FIFO_ray_o            = Module(new FIFO_0(96,10))
    val FIFO_ray_d            = Module(new FIFO_0(96,10))
    val FIFO_node            = Module(new FIFO(32,10))
    val FIFO_hitT               = Module(new FIFO_0(32,10))
