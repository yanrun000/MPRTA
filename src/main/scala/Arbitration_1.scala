...
//         val fifo_rd                                          = RegInit(0.U(2.W))

//         when(fifo_rd =/= 2.U){
//             fifo_rd                     := fifo_rd+1.U
//         }.elsewhen(fifo_rd ===2.U ){
//             fifo_rd                     := 0.U
//         }
//         when(FIFO_A_1_0_node.io.empty === 0.U&&fifo_rd === 0.U){
...
//         }.elsewhen(FIFO_A_1_1_node.io.empty === 0.U&&fifo_rd === 1.U){
...
//         }.elsewhen(FIFO_A_1_2_node.io.empty === 0.U &&fifo_rd===2.U){
//             FIFO_A_1_0_node.io.rd          := false.B
//             FIFO_A_1_0_ray.io.rd              := false.B
//             FIFO_A_1_0_hit.io.rd               := false.B
//             FIFO_A_1_1_node.io.rd          := false.B
...
//         when(FIFO_0_empty === 0.U&&fifo_rd === 1.U){
