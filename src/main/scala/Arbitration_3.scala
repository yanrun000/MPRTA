...
class Arbitration_3 extends Module{
    val io = IO (new Bundle{
        ...
        when(FIFO_A_3_0_node.io.empty === 0.U){
        ...
        }.elsewhen(FIFO_A_3_0_node.io.empty === 1.U && FIFO_A_3_1_node.io.empty === 0.U){
            ...
            FIFO_A_3_4_ray.io.rd              := false.B
            FIFO_A_3_4_hit.io.rd               := false.B
        }.elsewhen(FIFO_A_3_0_node.io.empty === 1.U && FIFO_A_3_1_node.io.empty === 1.U&& FIFO_A_3_2_node.io.empty === 0.U){
            FIFO_A_3_0_node.io.rd          := false.B
            FIFO_A_3_0_ray.io.rd              := false.B
            FIFO_A_3_0_hit.io.rd               := false.B
            FIFO_A_3_1_node.io.rd          := false.B
            ...
            FIFO_A_3_4_ray.io.rd              := false.B
            FIFO_A_3_4_hit.io.rd               := false.B
        }.elsewhen(FIFO_A_3_0_node.io.empty === 1.U && FIFO_A_3_1_node.io.empty === 1.U&& FIFO_A_3_2_node.io.empty === 1.U&&FIFO_A_3_3_node.io.empty === 0.U){
            FIFO_A_3_0_node.io.rd          := false.B
            FIFO_A_3_0_ray.io.rd              := false.B
            FIFO_A_3_0_hit.io.rd               := false.B
            FIFO_A_3_1_node.io.rd          := false.B
            ...
            FIFO_A_3_4_ray.io.rd              := false.B
            FIFO_A_3_4_hit.io.rd               := false.B
        }.elsewhen(FIFO_A_3_0_node.io.empty === 1.U && FIFO_A_3_1_node.io.empty === 1.U&& FIFO_A_3_2_node.io.empty === 1.U&&FIFO_A_3_3_node.io.empty === 1.U&&FIFO_A_3_4_node.io.empty === 0.U){
            FIFO_A_3_0_node.io.rd          := false.B
            FIFO_A_3_0_ray.io.rd              := false.B
            FIFO_A_3_0_hit.io.rd               := false.B
            FIFO_A_3_1_node.io.rd          := false.B
        ...
        when(FIFO_0_empty === 0.U){
            ...
            io.valid_out                         := valid_out_temp
        }.elsewhen(FIFO_0_empty === 1.U&&FIFO_1_empty === 1.U&&FIFO_2_empty === 1.U&&FIFO_3_empty === 1.U&&FIFO_4_empty === 0.U){
