...
class MY_MULADD extends Module{
...
class TesterSimple_3 (dut:MY_MULADD) extends PeekPokeTester(dut){
...
object faddmul_3 extends App {
  chisel3.iotesters.Driver.execute(args, () => new MY_MULADD())(c => new TesterSimple_3(c))
}
