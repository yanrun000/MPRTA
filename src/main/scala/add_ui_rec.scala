...
//     })
// val ui_32to_rec32 = Module (new ValExec_I32ToRecF32)
...
// // poke(dut.io.b,1.U)
// poke(dut.io.expected.out,0.U)
// poke(dut.io.roundingMode,0.U)
// step(1)
// println("Result ui_rec is :" +peek(dut.io.actual.out).toString)
...
// // object UI_32TO_REC32 extends App {
// //   (new chisel3.stage.ChiselStage).emitVerilog(new UI_32TO_REC32())
// // }
