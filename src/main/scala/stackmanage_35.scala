...
class Stackmanage extends Module{
    ...
    val Stack_25                        = Module(new Stack(32))
    val Stack_26                      = Module(new Stack(32))
    val Stack_27                      = Module(new Stack(32))
    val Stack_28                      = Module(new Stack(32))
    val Stack_29                      = Module(new Stack(32))
    val Stack_30                      = Module(new Stack(32))
    val Stack_31                      = Module(new Stack(32))
    val Stack_32                        = Module(new Stack(32))
    val Stack_33                       = Module(new Stack(32))
    val Stack_34                       = Module(new Stack(32))
    ...
    val dispatch_no_match       = RegInit(0.U(1.W))
...
//--------------------------------------------
    ...
    dispatch_no_match   := LUT_stack.io.no_match
    ...
    io.Dis_en                               := (dispatch_0===1.U || dispatch_1===1.U || dispatch_2===1.U || dispatch_3===1.U || dispatch_4 ===1.U|| dispatch_5 ===1.U|| dispatch_6===1.U || dispatch_7===1.U || dispatch_8===1.U || dispatch_9===1.U ||dispatch_10===1.U || dispatch_11===1.U || dispatch_12===1.U || dispatch_13===1.U || dispatch_14 ===1.U|| dispatch_15 ===1.U|| dispatch_16===1.U || dispatch_17===1.U || dispatch_18===1.U || dispatch_19===1.U ||dispatch_20===1.U || dispatch_21===1.U || dispatch_22===1.U || dispatch_23===1.U || dispatch_24 ===1.U        
                                                                || dispatch_25 ===1.U|| dispatch_26===1.U || dispatch_27===1.U || dispatch_28===1.U || dispatch_29===1.U ||dispatch_30===1.U || dispatch_31===1.U || dispatch_32===1.U || dispatch_33===1.U || dispatch_34 ===1.U || dispatch_no_match === 1.U)
    io.Finish                                 := (Stack_0.io.empty&&Stack_1.io.empty&&Stack_2.io.empty&&Stack_3.io.empty&&Stack_4.io.empty&&Stack_5.io.empty&&Stack_6.io.empty&&Stack_7.io.empty&&Stack_8.io.empty&&Stack_9.io.empty&&Stack_10.io.empty&&Stack_11.io.empty&&Stack_12.io.empty&&Stack_13.io.empty&&Stack_14.io.empty&&Stack_15.io.empty&&Stack_16.io.empty&&Stack_17.io.empty&&Stack_18.io.empty&&Stack_19.io.empty &&Stack_20.io.empty&&Stack_21.io.empty&&Stack_22.io.empty&&Stack_23.io.empty&&Stack_24.io.empty
                                                                &&Stack_25.io.empty&&Stack_26.io.empty&&Stack_27.io.empty&&Stack_28.io.empty&&Stack_29.io.empty &&Stack_30.io.empty&&Stack_31.io.empty&&Stack_32.io.empty&&Stack_33.io.empty&&Stack_34.io.empty )       
    io.dis_count    := (dispatch_0+dispatch_1+ dispatch_2+dispatch_3+dispatch_4+dispatch_5+dispatch_6+dispatch_7+dispatch_8+dispatch_9+dispatch_10+ dispatch_11+dispatch_12+dispatch_13+dispatch_14 +dispatch_15 + dispatch_16+ dispatch_17+ dispatch_18+ dispatch_19+dispatch_20+dispatch_21+ dispatch_22+ dispatch_23+dispatch_24         
                                                                + dispatch_25 + dispatch_26+dispatch_27+dispatch_28+dispatch_29+dispatch_30+dispatch_31+ dispatch_32+ dispatch_33+ dispatch_34 )
    ...
    LUT_stack.io.dispatch_25           := dispatch_25
    LUT_stack.io.dispatch_26           := dispatch_26
    LUT_stack.io.dispatch_27           := dispatch_27
    LUT_stack.io.dispatch_28           := dispatch_28
    LUT_stack.io.dispatch_29           := dispatch_29
    LUT_stack.io.dispatch_30           := dispatch_30
    LUT_stack.io.dispatch_31           := dispatch_31
    LUT_stack.io.dispatch_32           := dispatch_32
    LUT_stack.io.dispatch_33           := dispatch_33
    LUT_stack.io.dispatch_34           := dispatch_34
}
