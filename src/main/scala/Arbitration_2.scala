...
class Arbitration_2 extends Module{
    val io = IO (new Bundle{
        ...
        // }.elsewhen(FIFO_A_2_0_ray.io.empty === 1.U && FIFO_A_2_1_ray.io.empty === 1.U&&FIFO_A_2_2_ray.io.empty === 0.U){
            ...
            // FIFO_A_2_1_ray.io.rd              := false.B
            // FIFO_A_2_1_hit.io.rd               := false.B
            // FIFO_A_2_2_node.io.rd          := true.B
            // FIFO_A_2_2_ray.io.rd              := true.B
            // FIFO_A_2_2_hit.io.rd               := true.B
            // FIFO_A_2_3_node.io.rd          := false.B
        //     FIFO_A_2_3_ray.io.rd              := false.B
        //     FIFO_A_2_3_hit.io.rd               := false.B
        // }.elsewhen(FIFO_A_2_0_ray.io.empty === 1.U && FIFO_A_2_1_ray.io.empty === 1.U&&FIFO_A_2_2_ray.io.empty === 1.U&& FIFO_A_2_3_ray.io.empty === 1.U){
            // FIFO_A_2_0_node.io.rd          := false.B
            // FIFO_A_2_0_ray.io.rd              := false.B
            // FIFO_A_2_0_hit.io.rd               := false.B
            // FIFO_A_2_1_node.io.rd          := false.B
        ...
        // FIFO_2_empty                               := FIFO_A_2_3_ray.io.empty
        ...
        valid_out_temp                            := Mux(FIFO_A_2_0_ray.io.rd || FIFO_A_2_1_ray.io.rd,1.U,0.U)
        when(FIFO_0_empty === 0.U){
            // node_id_out_temp                  := FIFO_A_2_0_node.io.dataout
            ...
            // node_id_out_temp                  := FIFO_A_2_1_node.io.dataout
        ...
        //     // node_id_out_temp                  := FIFO_A_2_2_node.io.dataout
        //     ray_id_out_temp                      := FIFO_A_2_2_ray.io.dataout
        //     hit_out_temp                             := FIFO_A_2_2_hit.io.dataout
