...
// using sub due to the sign value of the j coefficients
	...
	val temp3    =  chisel3.util.Cat(sub2_in2, "b0".U)
	val temp4    =  chisel3.util.Cat(temp3, "b0".U)
	sub2.io.in2 :=  chisel3.util.Cat(temp4, "b0".U)
...
//	using an adder due to the sign value of the c coefficients
	...
	val temp1     =  chisel3.util.Cat(sub2.io.out, "b0".U)
	val temp2     =  chisel3.util.Cat(temp1, "b0".U)
	adder.io.in1 := temp2
	...
	val adder_out_reg = RegInit(0.U(25.W))
	adder_out_reg	:= adder.io.out
	val adder_out_reg_2 = RegInit(0.U(25.W))
	adder_out_reg_2	:= adder_out_reg
	val mul3     = Module(new mul3(w, 25, 24))
	
	mul3.io.in1 := sub1_out_reg2
	mul3.io.in2 := adder_out_reg_2
...
// object fpInverter extends App {
//   (new chisel3.stage.ChiselStage).emitVerilog(new fpInverter(32))
// }
