...
class ray_AABB_1 extends Module{
    ...
    val rayid_temp       = RegInit(0.U(32.W))
    val hitT_temp         = RegInit(0.U(32.W))
    val tmin_temp       = RegInit(0.U(32.W))
    val valid_temp       = RegInit(0.U(32.W))
    ...
    val cidx_0_temp                   = RegInit(0.S(32.W))
    val cidx_1_temp                   = RegInit(0.S(32.W))


    cidx_0_temp                         := cidx_0_1
    cidx_1_temp                         := cidx_1_1


    val FADD_MUL_1      = Module(new MY_MULADD )
    ...
    c0lox                           :=  FADD_MUL_1.io.out

    val FADD_MUL_2      = Module(new MY_MULADD)
    ...
    c0hix                           :=  FADD_MUL_2.io.out

    val FADD_MUL_3      = Module(new MY_MULADD )
    ...
    c0loy                           :=  FADD_MUL_3.io.out

    val FADD_MUL_4      = Module(new MY_MULADD )
    ...
    c0hiy                           := FADD_MUL_4.io.out
    
    val FADD_MUL_5      = Module(new MY_MULADD )
    ...
    c0loz                           :=  FADD_MUL_5.io.out

    val FADD_MUL_6      = Module(new MY_MULADD )
    ...
    c0hiz                           :=  FADD_MUL_6.io.out

    val FADD_MUL_7      = Module(new MY_MULADD )
    ...
    c1lox                           :=  FADD_MUL_7.io.out

    val FADD_MUL_8      = Module(new MY_MULADD )
    ...
    c1hix                           :=  FADD_MUL_8.io.out

    val FADD_MUL_9      = Module(new MY_MULADD )
    ...
    c1loy                           :=  FADD_MUL_9.io.out

    val FADD_MUL_10     = Module(new MY_MULADD )
    ...
    c1hiy                           :=  FADD_MUL_10.io.out
    
    val FADD_MUL_11     = Module(new MY_MULADD )
    ...
    c1loz                           :=  FADD_MUL_11.io.out

    val FADD_MUL_12     = Module(new MY_MULADD )
    ...
    cidx_0_2                         := cidx_0_temp
    cidx_1_2                         := cidx_1_temp
...
// }
object RAY_AABB extends App {
  (new chisel3.stage.ChiselStage).emitVerilog(new ray_AABB_1())
}
