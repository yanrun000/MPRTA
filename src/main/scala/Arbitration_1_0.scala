...
// //这个感觉是决定遍历速率的关键，不可以使用某一优先级最高的仲裁，这样会导致很多器件空闲
// class Arbitration_1 extends Module{
//     val io = IO (new Bundle{
//         val node_id_0            = Input(SInt(32.W))
//         val ray_id_0                = Input(UInt(32.W))
...
//         val FIFO_A_1_0_node  = Module(new FIFO(32,25))
//         val FIFO_A_1_0_ray      = Module(new FIFO_0(32,25))
//         val FIFO_A_1_0_hit       = Module(new FIFO_0(32,25))
        
//         val FIFO_A_1_1_node  = Module(new FIFO(32,25))
//         val FIFO_A_1_1_ray      = Module(new FIFO_0(32,25))

//         val FIFO_A_1_2_node  = Module(new FIFO(32,25))
//         val FIFO_A_1_2_ray      = Module(new FIFO_0(32,25))
...
//         val fifo0_rd                                        = RegInit(1.U(2.W))
//         val fifo1_rd                                        = RegInit(0.U(2.W))
//         val fifo2_rd                                        = RegInit(0.U(2.W))
//        when(fifo0_rd =/= 3.U){
//            fifo0_rd         := fifo0_rd+1.U
//        }.elsewhen(fifo0_rd === 3.U){

//        }
       
       
//         // when 
//         // when(FIFO_A_1_0_node.io.empty === 0.U&&FIFO_A_1_1_node.io.empty === 1.U&&FIFO_A_1_2_node.io.empty === 1.U){
...
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 1.U&&FIFO_A_1_1_node.io.empty === 0.U&&FIFO_A_1_2_node.io.empty === 1.U){
...
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 0.U&&FIFO_A_1_1_node.io.empty === 1.U&&FIFO_A_1_2_node.io.empty === 0.U&& fifo0_rd === 0.U){
//         //     FIFO_A_1_0_node.io.rd          := true.B
//         //     FIFO_A_1_0_ray.io.rd              := true.B
//         //     FIFO_A_1_0_hit.io.rd               := true.B
//         //     FIFO_A_1_1_node.io.rd          := false.B
...
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 0.U&&FIFO_A_1_1_node.io.empty === 1.U&&FIFO_A_1_2_node.io.empty === 0.U&& fifo0_rd  === 1.U){
//         //     FIFO_A_1_0_node.io.rd          := false.B
//         //     FIFO_A_1_0_ray.io.rd              := false.B
//         //     FIFO_A_1_0_hit.io.rd               := false.B
//         //     FIFO_A_1_1_node.io.rd          := true.B
...
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 0.U&&FIFO_A_1_1_node.io.empty === 0.U&&FIFO_A_1_2_node.io.empty === 1.U&& fifo0_rd === 0.U){
//         //     FIFO_A_1_0_node.io.rd          := true.B
//         //     FIFO_A_1_0_ray.io.rd              := true.B
//         //     FIFO_A_1_0_hit.io.rd               := true.B
//         //     FIFO_A_1_1_node.io.rd          := false.B
...
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 0.U&&FIFO_A_1_1_node.io.empty === 0.U&&FIFO_A_1_2_node.io.empty === 1.U&& fifo0_rd === 2.U){
//         //     FIFO_A_1_0_node.io.rd          := true.B
//         //     FIFO_A_1_0_ray.io.rd              := true.B
//         //     FIFO_A_1_0_hit.io.rd               := true.B
//         //     FIFO_A_1_1_node.io.rd          := false.B
...
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 1.U&&FIFO_A_1_1_node.io.empty === 0.U&&FIFO_A_1_2_node.io.empty === 0.U&& fifo0_rd === 0.U){
//         //     FIFO_A_1_0_node.io.rd          := false.B
//         //     FIFO_A_1_0_ray.io.rd              := false.B
//         //     FIFO_A_1_0_hit.io.rd               := false.B
//         //     FIFO_A_1_1_node.io.rd          := true.B
...
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 1.U&&FIFO_A_1_1_node.io.empty === 0.U&&FIFO_A_1_2_node.io.empty === 0.U&& fifo0_rd === 2.U){
//         //     FIFO_A_1_0_node.io.rd          := false.B
//         //     FIFO_A_1_0_ray.io.rd              := false.B
//         //     FIFO_A_1_0_hit.io.rd               := false.B
//         //     FIFO_A_1_1_node.io.rd          := false.B
...
//         //     fifo0_rd                                          := 0.U
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 0.U&&FIFO_A_1_1_node.io.empty === 0.U&&FIFO_A_1_2_node.io.empty === 0.U&& fifo0_rd === 0.U){
//         //     FIFO_A_1_0_node.io.rd          := true.B
//         //     FIFO_A_1_0_ray.io.rd              := true.B
//         //     FIFO_A_1_0_hit.io.rd               := true.B
//         //     FIFO_A_1_1_node.io.rd          := false.B
...
//         //     fifo0_rd                                          := 1.U
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 0.U&&FIFO_A_1_1_node.io.empty === 0.U&&FIFO_A_1_2_node.io.empty === 0.U&& fifo0_rd === 1.U){
//         //     FIFO_A_1_0_node.io.rd          := false.B
//         //     FIFO_A_1_0_ray.io.rd              := false.B
//         //     FIFO_A_1_0_hit.io.rd               := false.B
//         //     FIFO_A_1_1_node.io.rd          := true.B
...
//         //     fifo0_rd                                          := 2.U
//         // }.elsewhen(FIFO_A_1_0_node.io.empty === 0.U&&FIFO_A_1_1_node.io.empty === 0.U&&FIFO_A_1_2_node.io.empty === 0.U&& fifo0_rd === 2.U){
//         //     FIFO_A_1_0_node.io.rd          := false.B
//         //     FIFO_A_1_0_ray.io.rd              := false.B
//         //     FIFO_A_1_0_hit.io.rd               := false.B
//         //     FIFO_A_1_1_node.io.rd          := true.B
...
//     //         fifo0_rd                                          := 1.U
//     //    }.elsewhen(FIFO_A_1_2_node.io.empty === 1.U && FIFO_A_1_1_node.io.empty === 0.U){
//     //         FIFO_A_1_0_node.io.rd          := false.B
//     //         FIFO_A_1_0_ray.io.rd              := false.B
//     //         FIFO_A_1_0_hit.io.rd               := false.B
//     //         FIFO_A_1_1_node.io.rd          := true.B
...
//         // }.elsewhen(FIFO_A_1_2_node.io.empty === 1.U && FIFO_A_1_1_node.io.empty === 1.U&&FIFO_A_1_0_node.io.empty === 0.U){
//         //     FIFO_A_1_0_node.io.rd          := true.B
//         //     FIFO_A_1_0_ray.io.rd              := true.B
//         //     FIFO_A_1_0_hit.io.rd               := true.B
//         //     FIFO_A_1_1_node.io.rd          := false.B
