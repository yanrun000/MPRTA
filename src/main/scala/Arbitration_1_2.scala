...
//         when(FIFO_A_1_1_node.io.empty === 0.U){
...
//         }.elsewhen(FIFO_A_1_1_node.io.empty === 1.U && FIFO_A_1_0_node.io.empty === 0.U){
...
//         }.elsewhen(FIFO_A_1_1_node.io.empty === 1.U && FIFO_A_1_0_node.io.empty === 1.U&&FIFO_A_1_2_node.io.empty === 0.U){
//             FIFO_A_1_0_node.io.rd          := false.B
//             FIFO_A_1_0_ray.io.rd              := false.B
//             FIFO_A_1_0_hit.io.rd               := false.B
//             FIFO_A_1_1_node.io.rd          := false.B
...
//         }.elsewhen(FIFO_1_empty === 1.U&&FIFO_0_empty === 0.U){
...
//             io.valid_out                         := valid_out_temp
//             // valid_out_temp                         := 1.U
//         }.elsewhen(FIFO_1_empty === 1.U&&FIFO_0_empty === 1.U&&FIFO_2_empty === 0.U){
